...
class PlanGeneratorController {
    ...
    public ResponseEntity<CreateDayResponse> createFirstDayOfPlan(@RequestBody FirstDayRequest firstDayRequest) {
        ...
        ResultDay firstDayOfPlan = planGeneratorFacade.createFirstDayOfPlan(preferencesDto, userIngs);
    ...
    public ResponseEntity<CreateDayResponse> createNextDayOfPlan(@RequestBody NextDayRequest nextDayRequest){
        ...
        ResultDay nextDayOfPlan = planGeneratorFacade.createNextDayOfPlan(preferencesDto, nextDayRequest.usedRecipesNames());
    ...
    public ResponseEntity<CreateDayResponse> changeDay(@RequestBody ChangeDayRequest changeDayRequest){
        ...
        ResultDay changedDay = planGeneratorFacade.changeLastDay(preferencesDto, changeDayRequest.recipesNamesToChange());
    ...
    private static PreferencesDto getPreferences(SavedPrefers savedPrefers, List<PanelValuesForMeal> mealsValues) {
